            ...
            <div class="box">
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    <?php
                    // Total de todas las deducciones definidas
                    ...
                    $sql = "SELECT 
                            ...
                            GROUP BY attendance.employee_id, employees.employee_id, employees.firstname, employees.lastname, position.rate
                    ...
                    while ($row = $query->fetch_assoc()) {
                      ...
                      $casql = "SELECT COALESCE(SUM(amount), 0) AS cashamount
                                FROM cashadvance
